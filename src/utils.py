...
udacity_classes = ["obstacles", "biker", "pedestrian", "car", "trafficLight-Green", "trafficLight-GreenLeft", "trafficLight-Red", "trafficLight-RedLeft", "trafficLight-Yellow", "trafficLight-YellowLeft",
                "truck","trafficLight"]
