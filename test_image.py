...
def get_args():
    ...
    parser.add_argument("--input", type=str, required=True, help="la ruta del input de la imagen")
    ...
    parser.add_argument("--output", type=str, default=None, help="la ruta del output de la imagen")
